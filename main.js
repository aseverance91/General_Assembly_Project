...
anchorElTwo.addEventListener('click',event => {
	var xhr = $.get("https://api.giphy.com/v1/gifs/random?tag=fuck&api_key=X3SR3WWlYTW8tzghpaqqhIWjF83h0vJc");
...
anchorEl.addEventListener('click',event => {
	var xhrl = $.get("https://api.giphy.com/v1/gifs/random?tag=Trump&api_key=X3SR3WWlYTW8tzghpaqqhIWjF83h0vJc");
